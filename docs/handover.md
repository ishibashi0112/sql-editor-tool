...
9. 段階2（SQL＋フォーム、D-26・D-27）：設計は §16（D-28、D-29、D-31）。§16 の 1〜3 は済み（2026-09-26）。残りは §16 の 4 と O-14。O-13 は §16 のとおり（Oracle は文字列から始めて利用者が直す）
